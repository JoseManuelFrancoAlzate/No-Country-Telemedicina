...
const DoctorsProfile = () => {
    ...
    console.log(router)
    const {data: doctorData, error, isLoading} = getEmailDoctors('goku12@gmail.com')
        ...
        <div className="bg-white shadow rounded-lg p-6 max-w-screen-lg mx-auto mt-8">
          ...
          <main className="grid grid-cols-2 gap-6">
            <section className="bg-green-100 p-4 rounded-lg shadow">
              ...
              <p className="mt-2">
                Your Email: <span className="text-gray-600">Eliakim.flores.Gamo@gmail.com</span>
              </p>
              <p className="mt-2">
            ...
            <section className="bg-green-100 p-4 rounded-lg shadow">
              ...
              <p className="mt-2">
                Your Name: <span className="text-gray-600">Eliakim Floress</span>
              </p>
              <p className="mt-2">
